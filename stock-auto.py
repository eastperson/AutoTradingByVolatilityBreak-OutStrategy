...
auth_token = 'xoxb-1886651932615-2243640796647-t2mNhKtSl103WgsLAJ9Rqpww'
...
def dbgout(message):
    ...
    post_message(auth_token,'#stock',strbuf)
...
# 목표가 설정은 변동성 돌파 전략으로 구성되어 있다.
# 해당 로직을 딥러닝으로 바꿔줄 수 있다.
...
if __name__ == '__main__': 
    try:
        ...
        buy_percent = 0.20 # 가용자금에서 몇 퍼센트를 살건지
        ...
        while True:
            ...
            if t_start < t_now < t_sell :  # AM 09:05 ~ PM 03:15 : 매수
                for sym in symbol_list:
                    # 우리가 산 것이 목표한 주식수보다 작으면 buy_etf 진행
